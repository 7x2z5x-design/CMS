...
<div class="content-header" style="margin-bottom: 1.5rem;">
    <h1 class="page-title" style="margin: 0; margin-bottom: 1rem;">Edit Tag</h1>
    ...
    <div class="card-body" style="padding: 1.5rem;">
        <form action="{{ route('admin.tags.update', $tag) }}" method="POST">
            ...
            <div class="form-group" style="margin-bottom: 1.5rem;">
                ...
                <input type="text" name="name" class="form-control" value="{{ old('name', $tag->name) }}" required style="width: 100%; padding: 0.75rem; border: 1px solid var(--border-color); border-radius: 8px;">
            ...
            <div style="margin-top: 2rem;">
                <button type="submit" class="btn btn-primary" style="width: 100%; padding: 0.75rem; border: none; border-radius: 8px; font-weight: 600; cursor: pointer;">Update Tag</button>
            </div>
        </form>
    </div>
</div>
